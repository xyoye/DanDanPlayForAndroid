...
public class AnimeDetailActivityV2 extends BaseMvpActivity<AnimeDetailPresenter> implements AnimeDetailView {
    ...
    public void onEvent(SearchMagnetEvent event) {
        ...
        Intent intent = new Intent(AnimeDetailActivityV2.this, SearchActivity.class);
        ...
        switch (view.getId()) {
            case R.id.anime_image_iv:
                if (animeDetailBean != null) {
                    Intent intent = new Intent(AnimeDetailActivityV2.this, ImagePreviewActivity.class);
