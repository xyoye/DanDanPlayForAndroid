...
import com.xyoye.dandanplay.utils.torrent.exception.TaskAlreadyAddedException;
...
import com.xyoye.dandanplay.utils.torrent.utils.TorrentHelper;
...
public class TorrentService extends Service {
    ...
    public static List<TaskStateBean> taskStateCache = new ArrayList<>();
    ...
    public void initListener() {
        engineCallback = new TorrentEngineCallback() {
            ...
            public void onTorrentFinished(String hash) {
                ...
                Iterator iterator = taskStateCache.iterator();
                while (iterator.hasNext()){
                    TaskStateBean taskStateBean = (TaskStateBean)iterator.next();
                    if (hash.equals(taskStateBean.torrentId))
                        iterator.remove();
                }
