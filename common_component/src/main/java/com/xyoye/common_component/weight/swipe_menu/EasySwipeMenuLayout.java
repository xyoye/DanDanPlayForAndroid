...
public class EasySwipeMenuLayout extends ViewGroup {
            ...
            case MotionEvent.ACTION_DOWN: {
                ...
                if (mViewCache != null) {
                    if (mViewCache != this) {
                        ...
                        mViewCache.handlerSwipeMenu(SwipeState.SWIPE_CLOSE);
                    }
                }
                break;
            }
    ...
    public void closeMenu() {
        if (mViewCache != null) {
            if (mSwipeState != null && mSwipeState != SwipeState.SWIPE_CLOSE && mScroller != null) {
