...
public final class DecoderSoLibrary {
  ...
  static {
    ExoPlayerLibraryInfo.registerModule("exo.extension.exoffmpeg");
  }

  private static final LibraryLoader LOADER = new LibraryLoader("ffmpeg", "exoffmpeg");
   ...
   * {@link com.google.android.exoplayer2.ext.ffmpeg.video.SoftVideoRenderer} instance.
   *
