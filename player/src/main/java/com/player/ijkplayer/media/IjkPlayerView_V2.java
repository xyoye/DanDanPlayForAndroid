...
import com.player.ijkplayer.widgets.BottomBarView;
import com.player.ijkplayer.widgets.DanmuBlockView;
import com.player.ijkplayer.widgets.DanmuPostView;
...
import com.player.ijkplayer.widgets.SkipTipView;
...
public class IjkPlayerView_V2 extends FrameLayout implements PlayerViewListener {
     ...
     * 外部接口回调
     */
    public IjkPlayerView_V2 setOnInfoListener(IMediaPlayer.OnInfoListener l) {
