...
import com.xyoye.player.danmaku.danmaku.model.AbsDisplayer;
import com.xyoye.player.danmaku.danmaku.model.BaseDanmaku;
import com.xyoye.player.danmaku.danmaku.model.DanmakuTimer;
import com.xyoye.player.danmaku.danmaku.model.ICacheManager;
import com.xyoye.player.danmaku.danmaku.model.IDanmakus;
import com.xyoye.player.danmaku.danmaku.model.IDrawingCache;
import com.xyoye.player.danmaku.danmaku.model.android.CachingPolicy;
import com.xyoye.player.danmaku.danmaku.model.android.DanmakuContext;
import com.xyoye.player.danmaku.danmaku.model.android.DanmakuFactory;
import com.xyoye.player.danmaku.danmaku.model.android.Danmakus;
import com.xyoye.player.danmaku.danmaku.model.android.DrawingCache;
import com.xyoye.player.danmaku.danmaku.model.android.DrawingCachePoolManager;
import com.xyoye.player.danmaku.danmaku.model.objectpool.Pool;
import com.xyoye.player.danmaku.danmaku.model.objectpool.Pools;
import com.xyoye.player.danmaku.danmaku.renderer.IRenderer.RenderingState;
import com.xyoye.player.danmaku.danmaku.util.DanmakuUtils;
import com.xyoye.player.danmaku.danmaku.util.SystemClock;
import com.xyoye.player.danmaku.jni.NativeBitmapFactory;
...
public class CacheManagingDrawTask extends DrawTask {
    ...
    public class CacheManager implements ICacheManager {
        ...
        public void onPlayStateChanged(int state) {
            if (mHandler != null) {
                mHandler.onPlayStateChanged(state == PLAY_STATE_PLAYING);
            }
        }
...
//Log.e("cache", "break at exception:" + e.getMessage());
    ...
    @Override
    public boolean onDanmakuConfigChanged(DanmakuContext config, DanmakuContext.DanmakuConfigTag tag,
                                          Object... values) {
        if (super.handleOnDanmakuConfigChanged(config, tag, values)) {
            // do nothing
        } else if (DanmakuContext.DanmakuConfigTag.SCROLL_SPEED_FACTOR.equals(tag)) {
            ...
            requestClear();
        } else if (DanmakuContext.DanmakuConfigTag.TRANSPARENCY.equals(tag) || DanmakuContext.DanmakuConfigTag.SCALE_TEXTSIZE.equals(tag) || DanmakuContext.DanmakuConfigTag.DANMAKU_STYLE.equals(tag)) {
            if (DanmakuContext.DanmakuConfigTag.SCALE_TEXTSIZE.equals(tag)) {
                mDisp.resetSlopPixel(mContext.scaleTextSize);
            }
            if (mCacheManager != null) {
                mCacheManager.requestClearAll();
