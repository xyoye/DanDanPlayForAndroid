...
import com.xyoye.player.danmaku.controller.CacheManagingDrawTask;

/**
 * Created by ch on 17/4/28. <br/>
 * The cacing policy apply to {@link CacheManagingDrawTask}
 * 提供缓存相关的策略设置: <br/>
...
//    public DanmakuTimer recyleTimer = new DanmakuTimer(SystemClock.uptimeMillis());
    ...
    /**
     * @see CacheManagingDrawTask.CacheManager
     */
