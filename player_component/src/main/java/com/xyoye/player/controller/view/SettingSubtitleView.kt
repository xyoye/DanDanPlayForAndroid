...
class SettingSubtitleView(
    ...
    private val subtitleImageView: SubtitleImageView,
    ...
    init {
        ...
        subtitleTextView.getSubtitleManager().observerOnSubtitleLoad { sourceUrl, isLoaded ->
    ...
    private fun initSettingListener() {
        ...
        viewBinding.addSubtitleTrackTv.setOnClickListener {
            ...
            mControlWrapper.switchSubtitleSource()
        }
    ...
    private fun selectTrack(position: Int) {
        ...
        when {
            ...
            TrackUtils.isEmptyTrack(currentSelectTrack) -> {
                ...
                subtitleImageView.setSubtitleEnable(false)
                return
            }
            //选中外挂字幕流
    ...
    fun setSubtitlePath(url: String?) {
        if (url.isNullOrEmpty())
            return
        subtitleTextView.setSubtitlePath(url)
    }
